...
from .schema import SapphireProjectConfig
...
def load_config(
    ...
    Args:
        project_slug: The project slug (e.g., 'molina', 'bcbs_il')
        config_dir: Optional path to config directory. Defaults to sapphire/configs/

    Returns:
        SapphireProjectConfig: Validated project configuration
    ...
    return SapphireProjectConfig(**merged)
